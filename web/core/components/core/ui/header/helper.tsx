...
/**
 * Combines header styles based on variant and options
 * @param variant - Header variant type
 * @param setMinHeight - Whether to apply min-height
 * @param showOnMobile - Visibility on mobile for secondary variant
