...
export const API_AUTH_REGISTRATION_ACTIVATE = (activationCode: string) =>
  `${API_ENDPOINT}/auth/registration/activate/${activationCode}`;
...
export const API_AUTH_VERIFY_DEVICE = (token: string) => `${API_ENDPOINT}/auth/verify/device/${token}`;
export const API_AUTH_VERIFY_OTP = `${API_ENDPOINT}/auth/verify-otp`;

// PASSWORD-API
export const API_PASSWORD_ENDPOINT = `${API_ENDPOINT}/password`;
export const API_PASSWORD_GET_INFO = (id: string) => `${API_PASSWORD_ENDPOINT}/${id}/info`;
export const API_PASSWORD_IS_EMPTY = `${API_PASSWORD_ENDPOINT}/isEmpty`;
export const API_PASSWORD_EXPIRY_POLICIES = `${API_PASSWORD_ENDPOINT}/policies`;
export const API_PASSWORD_CATEGORIES = `${API_PASSWORD_ENDPOINT}/categories`;
export const API_PASSWORD_GET_DECRYPTED = (id: number) => `${API_PASSWORD_ENDPOINT}/decrypt/${id}`;
export const API_PASSWORD_FAVORITE_PW = (id: number) => `${API_PASSWORD_ENDPOINT}/favorite/${id}`;
export const API_PASSWORD_SEARCH_BY_QUERY = `${API_PASSWORD_ENDPOINT}/search`;
export const API_PASSWORD_VAULT_HEALTH = `${API_PASSWORD_ENDPOINT}/health`;
export const API_PASSWORD_DELETE_ALL = `${API_PASSWORD_ENDPOINT}/delete`;
export const API_PASSWORD_DELETE_BY_ID = (id: number) => `${API_PASSWORD_ENDPOINT}/delete/${id}`;
export const API_UPDATE_PASSWORD = (id: number) => `${API_PASSWORD_ENDPOINT}/update/${id}`;
export const API_UPDATE_PASSWORD_USERNAME = (id: number) => `${API_PASSWORD_ENDPOINT}/username/update/${id}`;
export const API_UPDATE_PASSWORD_NOTES = (id: number) => `${API_PASSWORD_ENDPOINT}/notes/update/${id}`;
// DashboardApi
export const API_DASHBOARD_EXPIRING_PASSWORD = `${API_ENDPOINT}/dashboard/expiring`;
export const API_DASHBOARD_RECENT_PASSWORD = `${API_ENDPOINT}/dashboard/recent`;
export const API_DASHBOARD_ALL_PASSWORDS = `${API_ENDPOINT}/password`;
export const API_DASHBOARD_CREATE_PASSWORD = `${API_ENDPOINT}/password`;

export const API_DASH_GOALS_ALL = `${API_ENDPOINT}/dashboard/goals/all`;
export const API_DASHBOARD_CREATE_GOAL = `${API_ENDPOINT}/dashboard/goals/new`;
export const API_DASHBOARD_UPDATE_GOAL = (goalId: string | number) =>
  `${API_ENDPOINT}/dashboard/goals/update/${goalId}`;
export const API_DASHBOARD_DELETE_GOAL = (goalId: string | number) =>
  `${API_ENDPOINT}/dashboard/goals/delete/${goalId}`;
export const API_DASHBOARD_DELETE_ALL_GOAL = `${API_ENDPOINT}/dashboard/goals/delete/all`;

export const API_DASHBOARD_CREATE_SUBGOAL = (goalId: string | number) =>
  `${API_ENDPOINT}/dashboard/subgoal/new/${goalId}`;
export const API_DASHBOARD_UPDATE_SUBGOAL = (subgoalId: string | number) =>
  `${API_ENDPOINT}/dashboard/subgoal/update/${subgoalId}`;
export const API_DASHBOARD_DELETE_SUBGOAL = (subgoalId: string | number) =>
  `${API_ENDPOINT}/dashboard/subgoal/delete/${subgoalId}`;
export const API_DASHBOARD_DELETE_ALL_SUBGOAL = (goalId: string | number) =>
  `${API_ENDPOINT}/dashboard/subgoal/delete/all/${goalId}`;

export const API_DASHBOARD_TASKS_ALL = `${API_ENDPOINT}/dashboard/tasks/all`;
export const API_DASHBOARD_CREATE_Task = `${API_ENDPOINT}/dashboard/tasks/new`;
export const API_DASHBOARD_UPDATE_TASK = (taskId: string | number) =>
  `${API_ENDPOINT}/dashboard/tasks/update/${taskId}`;
export const API_DASHBOARD_DELETE_TASK = (taskId: string | number) =>
  `${API_ENDPOINT}/dashboard/tasks/delete/${taskId}`;
export const API_DASHBOARD_DELETE_ALL_TASK = `${API_ENDPOINT}/dashboard/tasks/delete/all`;
...
// export const API_CHAT_MESSAGES = (chatId: number) =>
//   `${API_ENDPOINT}/chat/${chatId}/messages`;
// export const API_CHAT_READ_MESSAGES = (chatId: number) =>
//   `${API_ENDPOINT}/chat/${chatId}/read/messages`;
...
// export const API_LISTS_TWEETS = (listId: number) =>
//   `${API_ENDPOINT}/lists/${listId}/tweets`;
// export const API_LISTS_DETAILS = (listId: number) =>
//   `${API_ENDPOINT}/lists/${listId}/details`;
// export const API_LISTS_FOLLOWERS = (listId: number, listOwnerId: number) =>
//   `${API_ENDPOINT}/lists/${listId}/${listOwnerId}/followers`;
// export const API_LISTS_MEMBERS = (listId: number, listOwnerId: number) =>
//   `${API_ENDPOINT}/lists/${listId}/${listOwnerId}/members`;
