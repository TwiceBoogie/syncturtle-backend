...
// */
// protected UpdateQueryResult buildUpdateQuery(Object entity, String tableName, String
// identifierColumn)
// throws IllegalAccessException {
...
// updateValues.append(", ");
// }
// updateValues.append(camelCaseToSnakeCase(field.getName())).append(" =
...
// protected void executeUpdateQuery(UpdateQueryResult result, String identifierColumn) throws
// ParseException {
...
// String priorityStatusStr = values.get(keys.peek()); // Assuming priorityStatus is represented as
// a
// // string
