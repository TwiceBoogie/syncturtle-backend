...
public class ErrorMessage {
        ...
        public static final String DEVICE_KEY_NOT_FOUND_OR_MATCH = "New device detected, please check your email to continue.";
        ...
        public static final String DEVICE_VERIFICATION_INVALID = "The provided device verification code is invalid.";
