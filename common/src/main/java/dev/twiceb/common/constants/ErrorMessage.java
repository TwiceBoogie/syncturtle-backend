...
public class ErrorMessage {
    ...
    public static final String AUTHORIZATION_ERROR =
            "Access Denied: You are not authorized to view/access this resource.";
    ...
    public static final String VERIFY_ACCOUNT_WITH_EMAIL =
            "Account has not been verified. Please check your email for activation code.";
    public static final String LOCKED_ACCOUNT_AFTER_N_ATTEMPTS =
            "Account locked due to multiple unsuccessful login attempts. Please wait ";
    public static final String DEVICE_KEY_NOT_FOUND_OR_MATCH =
            "New device detected, please check your email to continue.";
    public static final String ACTIVATION_CODE_EXPIRED =
            "Verification token has expired. Please try again.";
    public static final String DEVICE_VERIFICATION_EXPIRED =
            "Your device verification code has expired. "
    ...
    public static final String DEVICE_VERIFICATION_INVALID =
            "The provided device verification code is invalid.";
    // MAGIC
    public static final String MAGIC_CODE_REGEX = "^[a-z]{4}-[a-z]{4}-[a-z]{4}$";
    public static final String MAGIC_CODE_INVALID =
            "Magic code must follow the format xxxx-xxxx-xxxx using lowercase letters only.";
    ...
    public static final String GENERATED_PASSWORD_LENGTH = "Length must be 8 or higher";
    ...
    public static final String EMPTY_PASSWORD_CONFIRMATION =
            "Password confirmation cannot be empty.";
    public static final String SHORT_PASSWORD =
            "Your password needs to be at least 8 characters. Please enter a longer one.";
    public static final String SAME_SAVED_PASSWORD =
    ...
    public static final String USERNAME_EXIST_FOR_DOMAIN =
            "Please use a different username than prior.";
    public static final String EMPTY_UPDATE_INPUT =
            "You must have at least 1 value you want to update.";
    ...
    public static final String EXCEED_GOAL_DESC_SIZE =
            "Description must not exceed 255 characters.";
    public static final String WRONG_DATE_PATTERN =
            "Please make sure date is formated like -> yyyy-MM-dd.";
    ...
    public static final String EXCEED_SUBGOAL_DESC_SIZE =
            "Description must not exceed 255 characters.";
    public static final String INVALID_ID_PROVIDED = "Please enter a valid goal id.";

    public static final String EXCEED_SUBGOAL_SIZE =
            "You can only have a max of 10 subgoals for each goal";
    public static final String EXCEED_SUBTASK_SIZE =
            "You can only have a max of 10 Subtasks per task.";
    ...
    public static final String EXCEED_TASK_DESC_SIZE =
            "Description must not exceed 255 characters.";
    public static final String EMPTY_DUE_DATE = "Please enter a due date.";
    public static final String EMPTY_RECURRENCE_PATTERN =
            "Please enter 1 of the following options provided.";
    public static final String DUPLICATE_RECURRENCE_TASK =
            "A recurring task with the same name already exist.";
    ...
    public static final String EXCEED_SUBTASK_DESC_SIZE =
            "Description must not exceed 255 characters.";
    public static final String INVALID_ID_PROVIDED_TASK = "Please enter a valid task id.";

    public static final String ACTIVATION_CODE_NOT_FOUND =
            "The activation code you provided is invalid or expired";
    public static final String ACCOUNT_ALREADY_VERIFIED = "Account already verified.";
    public static final String ACTIVATION_CODE_GENERATION_FAIL =
            "Error generating activation code, please try again later.";
