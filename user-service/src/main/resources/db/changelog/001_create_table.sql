...
CREATE TABLE IF NOT EXISTS login_attempt_policy (
    ...
    lockout_duration INTERVAL,  -- Duration for lockout after reaching max attempts
    reset_duration INTERVAL,   -- Duration for resetting attempts (e.g., after successful login)
    created_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id)
);

INSERT INTO login_attempt_policy (policy_name, max_attempts, lockout_duration, reset_duration) VALUES
    ('Default Policy', 5, '5 minutes', '24 hours'),
    ('High Security Policy', 3, '15 minutes', '48 hours'),
...
CREATE TABLE IF NOT EXISTS activation_codes (
    ...
    code_type VARCHAR(20) NOT NULL, -- 'activation' or 'device_verification'
...
ALTER TABLE user_devices RENAME COLUMN device_info TO device_key;
...
CREATE TABLE IF NOT EXISTS login_attempts (
    ...
    ip_address VARCHAR(50), -- IPv4 or IPv6 address
