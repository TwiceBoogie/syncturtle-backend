...
@SecurityScheme(name = "deviceAuth", // Reference
                                     // name
                                     // for
                                     // device
                                     // authentication
                type = SecuritySchemeType.APIKEY, in = SecuritySchemeIn.HEADER,
                paramName = "X-User-DeviceKey" // Header
                                               // name
                                               // for
                                               // device
                                               // JWT
...
public interface AuthenticationControllerSwagger {
        ...
        @ApiResponse(responseCode = "401", description = "Invalid Login", content = {@Content(
                        ...
                        schema = @Schema(implementation = ApiErrorResponse.class),
                        examples = @ExampleObject(
                                        value = ApiResponseExamples.API_ERROR_INVALID_LOGIN))})
        @ApiResponse(responseCode = "403", description = "No device key jwt", content = {@Content(
                        mediaType = "application/json",
                        schema = @Schema(implementation = ApiErrorResponse.class),
                        examples = @ExampleObject(
                                        value = ApiResponseExamples.API_ERROR_NO_DEVICE_KEY))})
        ...
        @ApiResponse(responseCode = "404", description = USER_NOT_FOUND_WITH_EMAIL,
                        content = {@Content(mediaType = "application/json",
                                        schema = @Schema(implementation = ApiErrorResponse.class),
                                        examples = @ExampleObject(
                                                        value = ApiResponseExamples.API_ERROR_USER_NOT_FOUND_WITH_EMAIL))})
        ...
        @ApiResponse(responseCode = "400", description = "Validation error", content = {@Content(
                        ...
                        examples = @ExampleObject(
                                        value = ApiResponseExamples.API_ERROR_INPUT_ERROR))})
        @ApiResponse(responseCode = "404", description = "No Resource found", content = {@Content(
                        mediaType = "application/json",
                        schema = @Schema(implementation = ApiErrorResponse.class),
                        examples = @ExampleObject(
        ...
        @ApiResponse(responseCode = "200", description = "Successful response",
                        content = {@Content(mediaType = "application/json",
                                        schema = @Schema(implementation = GenericResponse.class))})
        @ApiResponse(responseCode = "400", description = "Reset token has expired",
                        content = {@Content(mediaType = "application/json",
                                        schema = @Schema(implementation = ApiErrorResponse.class),
                                        examples = @ExampleObject(
                                                        value = ApiResponseExamples.API_ERROR_PW_RESET_TOKEN_EXPIRED))})
        @ApiResponse(responseCode = "404", description = "Password reset token is invalid",
                        content = {@Content(mediaType = "application/json",
                                        schema = @Schema(implementation = ApiErrorResponse.class),
                                        examples = @ExampleObject(
                                                        value = ApiResponseExamples.API_ERROR_PW_RESET_TOKEN_NOT_FOUND))})
