...
public interface AuthenticationControllerSwagger {
    ...
    @ApiResponse(responseCode = "401",
            ...
            content = {
                    @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorResponse.class),
                            examples = @ExampleObject(value = ApiResponseExamples.API_ERROR_INVALID_LOGIN))
            })
    @ApiResponse(responseCode = "403",
            description = "No device key jwt",
            content = {
                    @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorResponse.class),
                            examples = @ExampleObject(value = ApiResponseExamples.API_ERROR_NO_DEVICE_KEY))
            })
    ...
    @ApiResponse(responseCode = "404",
            description = USER_NOT_FOUND_WITH_EMAIL,
            content = {
                    @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorResponse.class),
                            examples = @ExampleObject(value = ApiResponseExamples.API_ERROR_USER_NOT_FOUND_WITH_EMAIL))
            })
    ...
    @ApiResponse(responseCode = "400",
            ...
            content = {
                    @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorResponse.class),
                            examples = @ExampleObject(value = ApiResponseExamples.API_ERROR_PW_RESET_TOKEN_EXPIRED))
            })
    @ApiResponse(responseCode = "404",
            ...
            content = {
                    @Content(mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorResponse.class),
                            examples = @ExampleObject(value = ApiResponseExamples.API_ERROR_PW_RESET_TOKEN_NOT_FOUND))
            })
