...
@ApiResponse(responseCode = "401", description = JWT_TOKEN_EXPIRED,
...
public interface UserSettingsControllerSwagger {
    ...
    @Operation(summary = "Update user's gender",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful response",
                            content = @Content(mediaType = "application/json",
                                    schema = @Schema(type = "string",
    ...
    @Operation(summary = "Update user's profile pic",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful response",
                            content = @Content(mediaType = "application/json",
    ...
    @Operation(summary = "Delete profile pic",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful response",
