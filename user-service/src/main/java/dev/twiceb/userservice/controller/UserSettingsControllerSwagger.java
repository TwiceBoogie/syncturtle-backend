...
@ApiResponse(responseCode = "401", description = JWT_TOKEN_EXPIRED, content = @Content(
...
public interface UserSettingsControllerSwagger {
        ...
        @PutMapping(USERNAME)
        @Operation(summary = "Update user's username", responses = {@ApiResponse(
                        ...
                        @ApiResponse(responseCode = "400", description = "Validation error",
                                        content = {@Content(mediaType = "application/json",
                                                        ...
                                                        examples = @ExampleObject(
                                                                        value = ApiResponseExamples.API_ERROR_INPUT_ERROR))}),
                        @ApiResponse(responseCode = "409", description = USERNAME_ALREADY_TAKEN,
                                        content = @Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ApiErrorResponse.class),
                                                        examples = @ExampleObject(
                                                                        value = ApiResponseExamples.API_ERROR_USERNAME_TAKEN_EXAMPLE)))})
        ...
        @PutMapping(EMAIL)
        @Operation(summary = "Update user's email", responses = {@ApiResponse(responseCode = "200",
                        ...
                        @ApiResponse(responseCode = "400", description = "Validation error",
                                        content = {@Content(mediaType = "application/json",
                                                        ...
                                                        examples = @ExampleObject(
                                                                        value = ApiResponseExamples.API_ERROR_INPUT_ERROR))}),
                        @ApiResponse(responseCode = "409", description = EMAIL_ALREADY_TAKEN,
                                        content = @Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ApiErrorResponse.class),
                                                        examples = @ExampleObject(
                                                                        value = ApiResponseExamples.API_ERROR_EMAIL_TAKEN_EXAMPLE)))})
        ...
        @PutMapping(PHONE)
        @Operation(summary = "Update user's phone", responses = {@ApiResponse(responseCode = "200",
                        description = "Successful response",
                        content = @Content(mediaType = "application/json",
                                        schema = @Schema(
                                                        implementation = UserPhoneResponse.class))),
                        @ApiResponse(responseCode = "400", description = "Validation error",
                                        content = {@Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ApiErrorResponse.class),
        ...
        @PutMapping(GENDER)
        @Operation(summary = "Update user's gender", responses = {@ApiResponse(responseCode = "200",
                        description = "Successful response",
                        content = @Content(mediaType = "application/json",
                                        schema = @Schema(type = "string",
                                                        implementation = String.class))),
        ...
        @Operation(summary = "Update user's profile pic", responses = {@ApiResponse(
                        responseCode = "200", description = "Successful response",
                        content = @Content(mediaType = "application/json", schema = @Schema(
                                        implementation = ProfilePicResponse.class))),
                        @ApiResponse(responseCode = "404", description = "No Resource found",
                                        content = {@Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ApiErrorResponse.class),
                                                        examples = @ExampleObject(
                                                                        value = ApiResponseExamples.API_ERROR_NO_RESOURCE))})})
        ResponseEntity<ProfilePicResponse> updateProfilePic(@PathVariable Long userProfileId);

        @PostMapping(AVATAR)
        @Operation(summary = "Upload profile pics", responses = {@ApiResponse(responseCode = "200",
                        description = "Successful response",
                        content = @Content(mediaType = "application/json",
                                        array = @ArraySchema(schema = @Schema(
                                                        implementation = ProfilePicResponse.class)))),
                        @ApiResponse(responseCode = "400",
                                        description = "No files provided for upload or more than 10 pics uploaded",
                                        content = {@Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ApiErrorResponse.class),
                                                        examples = @ExampleObject(
                                                                        value = ApiResponseExamples.API_ERROR_FILES))})})
        ResponseEntity<List<ProfilePicResponse>> uploadProfilePics(
                        @RequestPart("files") MultipartFile[] files);

        @DeleteMapping(SET_AVATAR)
        @Operation(summary = "Delete profile pic", responses = {@ApiResponse(responseCode = "200",
                        description = "Successful response",
                        content = @Content(mediaType = "application/json",
                                        array = @ArraySchema(schema = @Schema(
                                                        implementation = ProfilePicResponse.class)))),
                        @ApiResponse(responseCode = "404", description = NO_RESOURCE_FOUND,
                                        content = {@Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ApiErrorResponse.class),
                                                        examples = @ExampleObject(
