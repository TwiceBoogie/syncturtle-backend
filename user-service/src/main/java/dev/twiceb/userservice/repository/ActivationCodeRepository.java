...
public interface ActivationCodeRepository extends JpaRepository<ActivationCode, UUID> {
    ...
    int updateActivationCodeByUserId(@Param("activationCode") String activationCode, @Param("userId") UUID userId);
    ...
    Optional<ActivationCode> findFirstByUser_IdAndCodeTypeOrderByExpirationTimeAsc(UUID userId, ActivationCodeType activationCodeType);
}
