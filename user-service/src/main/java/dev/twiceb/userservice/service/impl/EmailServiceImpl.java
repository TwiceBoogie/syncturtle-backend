...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendPasswordResetEmail(User user, String otp) {
        ...
        EmailRequest emailRequest =
                new EmailRequest.Builder(user.getEmail(), subject, "forgotPassword-template")
                        .attributes(
    ...
    public void sendDeviceVerificationEmail(User user, String magicCode, String ipAddress,
        ...
        EmailRequest emailRequest =
                new EmailRequest.Builder(user.getEmail(), subject, "deviceVerification-template")
    ...
    public void sendPasswordChangeNotificationEmail(UserDevice device, String verificationCode,
        ...
        String formattedDateTime = formatDateTime(LocalDateTime.now());
        EmailRequest emailRequest =
                new EmailRequest.Builder(user.getEmail(), subject, "passwordChange-template")
                        .attributes(
    ...
    private String formatDateTime(LocalDateTime dateTime) {
        DateTimeFormatter formatter =
                DateTimeFormatter.ofPattern("EEEE, MMMM d 'at' hh:mma", Locale.ENGLISH);
