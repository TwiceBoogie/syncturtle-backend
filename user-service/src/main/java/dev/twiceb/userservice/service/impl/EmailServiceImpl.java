...
public class EmailServiceImpl implements EmailService {
        ...
        public void sendMagicCodeEmail(String email, String magicCode) {
                String subject = String.format("Your unique SyncTurtle login code is %s",
                                magicCode);
                EmailRequest emailRequest =
                                new EmailRequest.Builder(email, subject, "plane-template")
                                                .attributes(Map.of("title", subject, "magicCode",
        ...
        public void sendPasswordResetEmail(User user, String otp) {
                ...
                EmailRequest emailRequest = new EmailRequest.Builder(user.getEmail(), subject,
                                "forgotPassword-template").attributes(
                                                Map.of("fullName", fullName, "passwordResetOtp",
                                                                otp.toCharArray()))
                                                .build();
                amqpPublisher.sendEmail(emailRequest);
        }
        ...
        public void sendPasswordResetLinkEmail(User user, String token) {
                ...
                EmailRequest emailRequest = new EmailRequest.Builder(user.getEmail(), subject,
                                "forgotPassword-template")
                                                .attributes(Map.of("fullname", fullName,
