...
// import static
// dev.twiceb.common.constants.ErrorMessage.ACCOUNT_ALREADY_VERIFIED;
// import static
// dev.twiceb.common.constants.ErrorMessage.ACTIVATION_CODE_EXPIRED;
...
// GenericResponse response = mapper.readValue(jsonResponse,
...
// @Test
// @DisplayName("[403] POST /ui/v1/auth/registration/check - Should user email
// is exist")
...
// @Test
// @DisplayName("[200] POST /ui/v1/auth/registration/code - Send registration
// code")
...
// assertThat(response).isInstanceOf(GenericResponse.class);
// assertThat(response.getMessage()).isEqualTo("Activation Code was sent to your
// email.");
// }

// @Test
// @DisplayName("[400] POST /ui/v1/auth/registration/code - Should user be
// verified already")
...
// .contentType(MediaType.APPLICATION_JSON_VALUE))
// .andExpect(status().isConflict()).andReturn().getResponse().getContentAsString();
// ApiErrorResponse response = mapper.readValue(jsonResponse,
...
// @Test
// @DisplayName("[200] GET /ui/v1/auth/registration/activate/{code} - Check
// registration code")
...
// .andExpect(status().isOk()).andExpect(jsonPath("$.deviceToken",
// isA(String.class)))
// .andExpect(jsonPath("$.message", is(
// "You've activated your user and you're now ready to use it! Try and login to
// access your user.")));
// }

// @Test
// @DisplayName("[410] GET /ui/v1/auth/registration/activate/{code} -
