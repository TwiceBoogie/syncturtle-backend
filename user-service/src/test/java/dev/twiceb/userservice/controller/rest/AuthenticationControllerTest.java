...
public class AuthenticationControllerTest {
    ...
    private String deviceKeyJwt;
    private String wrongDeviceKeyJwt;
    ...
    public void init() {
        ...
        String randomCodeForDeviceKey = "L3ZiU7TsQHuhK8JvGvW4Tw";
        String wrongRandomCodeForDeviceKey = "dGhpcyBpcyBhIHRlc3Qgc3RyaW5n";
        deviceKeyJwt = jwtProvider.createDeviceToken(randomCodeForDeviceKey);
        wrongDeviceKeyJwt = jwtProvider.createDeviceToken(wrongRandomCodeForDeviceKey);
    }
    ...
    public void login() throws Exception {
        mockMvc.perform(post(UI_V1_AUTH + LOGIN)
                ...
                .header(AUTH_USER_DEVICE_KEY, deviceKeyJwt)
    ...
    public void login_ShouldDeviceKeyNotBelongToUser() throws Exception {
        mockMvc.perform(post(UI_V1_AUTH + LOGIN)
                .content(mapper.writeValueAsString(authenticationRequest))
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .header(AUTH_USER_DEVICE_KEY, wrongDeviceKeyJwt)
                .header(AUTH_USER_AGENT_HEADER, TestConstants.USER_AGENT)
                .header(AUTH_USER_IP_HEADER, TestConstants.USER_IP))
