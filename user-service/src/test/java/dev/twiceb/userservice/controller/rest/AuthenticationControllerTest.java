...
// import static
// dev.twiceb.common.constants.ErrorMessage.DEVICE_KEY_NOT_FOUND_OR_MATCH;
// import static dev.twiceb.common.constants.ErrorMessage.INCORRECT_PASSWORD;
// import static
// dev.twiceb.common.constants.ErrorMessage.LOCKED_ACCOUNT_AFTER_N_ATTEMPTS;
...
// import static
// dev.twiceb.common.constants.ErrorMessage.USER_NOT_FOUND_WITH_EMAIL;
// import static
// dev.twiceb.common.constants.ErrorMessage.VERIFY_ACCOUNT_WITH_EMAIL;
...
// import static
// dev.twiceb.common.constants.PathConstants.VERIFY_DEVICE_VERIFICATION;
...
// "/sql-test/populate-user-db.sql" }, executionPhase =
// ExecutionPhase.BEFORE_TEST_METHOD)
// @Sql(value = { "/sql-test/clear-user-db.sql" }, executionPhase =
...
// .andExpect(jsonPath("$.deviceToken").doesNotExist()); // device token set in
...
// @Test
// @DisplayName("[403] POST /ui/v1/auth/login - Device key not present or does
// not belong to user")
...
// containsString(LOCKED_ACCOUNT_AFTER_N_ATTEMPTS)));
// }

// @Test
// @DisplayName("[403] POST /ui/v1/auth/login - User user is locked until they
// verify new device")
// public void login_ShouldUserBeLockedForNewDeviceVerification() throws
// Exception {
...
// @Test
// @DisplayName("[200] POST /ui/v1/auth/forgot/username - Send username to
// user's email")
...
// @Test
// @DisplayName("[404] POST /ui/v1/auth/forgot/username - User email not in
// database")
...
// @Test
// @DisplayName("[200] POST /ui/v1/auth/forgot/password - Send password reset
// otp to user's email")
...
// .contentType(MediaType.APPLICATION_JSON_VALUE))
// .andExpect(status().isOk())
// .andExpect(jsonPath("$.message", is("Check your email for the password
// otp")));
// }

// @Test
// @DisplayName("[402] POST /ui/v1/auth/forgot/password - User email not in
// database")
...
// @Test
// @DisplayName("[200] POST /ui/v1/auth/verify-otp - Verifies and sends a
// password reset link to user's email")
...
// .contentType(MediaType.APPLICATION_JSON_VALUE))
// .andExpect(status().isOk())
// .andExpect(jsonPath("$.message", is("OTP verified, check your email for the
// password reset link.")));
// }
...
// .contentType(MediaType.APPLICATION_JSON_VALUE))
// .andExpect(status().isOk())
// .andExpect(jsonPath("$.message", is("Password has been reset. Try to login
...
// @Test
// @DisplayName("[200] GET /ui/v1/auth/verify/device/{token} - New device
// trusted")
...
// .andExpect(jsonPath("$.token", isA(String.class)))
// .andExpect(jsonPath("$.deviceToken", isA(String.class))); // device token set
// in the registration
// // service
// }

// @Test
// @DisplayName("[423] GET /ui/v1/auth/verify/device/{token} - New device not
// trusted")
...
// @Test
// @DisplayName("[404] GET /ui/v1/auth/verify/device/{token} - New device token
// missing")
...
// @Test
// @DisplayName("[403] GET /ui/v1/auth/verify/device/{token} - New device token
// is wrong")
