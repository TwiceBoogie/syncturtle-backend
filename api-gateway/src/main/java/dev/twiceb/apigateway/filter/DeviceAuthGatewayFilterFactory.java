...
// private Mono<Void> handleLoginPath(ServerWebExchange exchange, GatewayFilterChain chain,
// String deviceToken) {
...
// private Mono<Void> handleOtherPaths(ServerWebExchange exchange, GatewayFilterChain chain,
// String deviceToken) {
// if (deviceToken != null && jwtProvider.validateToken(deviceToken, "deviceKey")) {
// String deviceKey = jwtProvider.parseDeviceToken(deviceToken);
// String userId = exchange.getAttribute("userId");

// return Optional.ofNullable(UUID.fromString(userId))
