...
// userRepository.findById(UUID.fromString(TestConstants.USER_ID));
...
// byte[] encryptedPassword = envelopeEncryption.encrypt("Twice_Mina1",
// randomKey, vector);
// System.out
// .println("Base64 Encoded Encrypted Password: "
// + Base64.getEncoder().encodeToString(encryptedPassword));
// System.out.println("Base64 Encoded Vector: " +
// Base64.getEncoder().encodeToString(vector.getIV()));
...
// Optional<EncryptionKey> savedKeyOpt =
// encryptionKeyRepository.findById(key.getId());
...
// String dekFromDb = jdbcTemplate.queryForObject(sql, new Object[] {
// savedKey.getId() }, String.class);
