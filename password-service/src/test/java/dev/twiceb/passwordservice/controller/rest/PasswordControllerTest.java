...
// "/sql-test/populate-password-db.sql" }, executionPhase =
// ExecutionPhase.BEFORE_TEST_METHOD)
// @Sql(value = { "/sql-test/clear-password-db.sql" }, executionPhase =
...
// public void init() {
// int index = 0;
// List<String> ids = List.of("f4f8a3d9-66d3-4e1a-a610-0cce26aaa956",
// "a0c60a16-d82e-46bc-942b-22f9ebbdbee5");
// while (index < 2) {
// Optional<User> userOpt =
// userRepository.findById(UUID.fromString(ids.get(index)));
...
// byte[] decryptedPassword = helper.encryptPassword("Twice_Mina1", randomKey,
// vector);
...
// // SecretKey secretKey = helper.rebuildSecretKey(ek.getDek(),
// // ek.getAlgorithm());
// //
...
// // byte[] encryptedPassword = helper.encryptPassword(originalPassword,
// // secretKey, vector);
// //
// // // Encode the encrypted password and IV to Base64 for storage or
// transmission
...
// // assertArrayEquals(encryptedPassword,
// // Base64.getDecoder().decode(encryptedPasswordBase64));
// // // Decode the Base64 encoded IV for decryption
// // byte[] decodedVector = Base64.getDecoder().decode(vectorBase64);
// // assertArrayEquals(encryptedPassword, keychain.getPassword(), "the
// encrypted
// // password bytes should be equal");
// // // Decrypt the password
// // String decryptedPassword = helper.decryptPassword(keychain.getPassword(),
// // secretKey, keychain.getVector());
// // String decryptedPassword2 = helper.decryptPassword(encryptedPassword,
// // secretKey, decodedVector);
// //
// // // Assert that the decrypted password matches the original password
// // assertEquals(originalPassword, decryptedPassword, "Decrypted password
// should
...
// private CreatePasswordRequest getCreatePasswordRequest(UUID encryptionId,
// String domain, String website) {
...
// CreatePasswordRequest request = getCreatePasswordRequest(
// this.encryptionKey1, TestConstants.SAME_DOMAIN,
// TestConstants.SAME_WEBSITE_URL);
// mockMvc.perform(post(UI_V1_PASSWORD).header(AUTH_USER_ID_HEADER,
// TestConstants.USER_ID)
// .content(mapper.writeValueAsString(request))
// .contentType(MediaType.APPLICATION_JSON_VALUE))
...
// @Test
// @DisplayName("[200] PATCH /ui/v1/password/update/{passwordId} - Update
// password only")
...
// @Test
// @DisplayName("[404] PATCH /ui/v1/password/update/{passwordId} - Password not
// found")
...
// @Test
// @DisplayName("[401] PATCH /ui/v1/password/update/{passwordId} - Password
// doesn't belong to user")
// public void updatePasswordOnly_ShouldPasswordNotBelongToUser() throws
// Exception {
// UpdatePasswordRequest request = new UpdatePasswordRequest();
// request.setPassword("Twice_Momo1");
// request.setConfirmPassword("Twice_Momo1");
...
// @Test
// @DisplayName("[409] PATCH /ui/v1/password/update/{passwordId} - New password
...
// @Test
// @DisplayName("[204] PUT /ui/v1/password/tags/{passwordId} - Update password
// tags")
...
// @Test
// @DisplayName("[404] PUT /ui/v1/password/tags/{passwordId} - No password found
// using the id")
...
// @Test
// @DisplayName("[201] PUT /ui/v1/password/favorite/{passwordId} - Update
// password favorite status")
...
// @Test
// @DisplayName("[404] PUT /ui/v1/password/favorite/{passwordId} - Password not
// found")
...
// @Test
// @DisplayName("[200] PATCH /ui/v1/password/username/update/{passwordId} -
// Update username on password")
// public void updateUsername() throws Exception {
// UpdatePasswordRequest request = new UpdatePasswordRequest();
// request.setUsername("randomUsername");
// mockMvc.perform(patch(UI_V1_PASSWORD + UPDATE_PASSWORD_USERNAME,
// this.keychainId1)
// .header(AUTH_USER_ID_HEADER, TestConstants.USER_ID)
// .header(AUTH_DEVICE_KEY_ID, TestConstants.DEVICE_ID_1)
// .content(mapper.writeValueAsString(request))
...
// @Test
// @DisplayName("[401] PATCH /ui/v1/password/username/update/{passwordId} -
// Password not found")
...
// @Test
// @DisplayName("[200] GET /ui/v1/password/{criteria} - Get user passwords with
// criteria (expiring)")
...
// @Test
// @DisplayName("[200] GET /ui/v1/password/{passwordId}/info - Get password
// info")
...
// @Test
// @DisplayName("[200] GET /ui/v1/password/decrypt/{passwordId} - Get decrypted
// password")
// public void getPassword_Decrypt() throws Exception {
// mockMvc.perform(get(UI_V1_PASSWORD + GET_DECRYPTED_PASSWORD,
// this.keychainId1)
// .header(AUTH_USER_ID_HEADER, TestConstants.USER_ID)
// .header(AUTH_DEVICE_KEY_ID, TestConstants.DEVICE_ID_1))
// .andExpect(status().isOk())
...
// @Test
// @DisplayName("[401] GET /ui/v1/password/decrypt/{passwordId} - Password not
// found")
