...
//        double weightedEntropyScore = getAverageEntropyScore() * getEntropyScoreWeight();
//        // 3.) calculate negative impact on password health
//        double negative_impact = weightedReusedScore + weightedWeakScore + weightedEntropyScore;
//
