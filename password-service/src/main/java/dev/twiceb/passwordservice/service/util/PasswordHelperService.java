...
import dev.twiceb.common.util.RepositoryWrapper;
...
public class PasswordHelperService extends ServiceHelper {
    ...
    public UserPasswordExpirySetting createUserPasswordExpirySetting(String policyName) {
        ...
        UserPasswordExpirySetting expirySetting = new UserPasswordExpirySetting();
    ...
    public void buildAnalyticEntities(Keychain keychain, String plainTextPassword) {
        keychain.setPasswordComplexityMetric(createPasswordComplexity(plainTextPassword));
        keychain.getPasswordComplexityMetric().setKeychain(keychain);
    ...
    public void updateSecureDataKey(Accounts account, Keychain oldKeychain, EncryptionKey oldEncryptionKey, String password) {
        try {
            ...
            oldKeychain.getPasswordChangeLogs().add(createPasswordChangeLog(oldKeychain));
